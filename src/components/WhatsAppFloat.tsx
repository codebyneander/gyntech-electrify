...
const WhatsAppFloat = () => (
  <a
    ...
    className="fixed bottom-5 right-5 z-[999] w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg shadow-[#25D366]/30 animate-pulse-glow hover:scale-110 transition-transform duration-300"
    aria-label="WhatsApp"
  >
