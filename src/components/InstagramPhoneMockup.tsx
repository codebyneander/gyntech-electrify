  ...
  <div className="hidden lg:flex items-center justify-center relative">
    ...
    <div className="relative animate-float">
      ...
      <a
        ...
        className="absolute -bottom-2 -right-4 z-30 flex items-center gap-2 px-4 py-2 text-xs font-semibold bg-primary text-primary-foreground rounded-full shadow-lg shadow-primary/30 hover:scale-105 transition-transform duration-300 animate-pulse-glow"
      >
